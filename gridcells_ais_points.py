# -*- coding: utf-8 -*-
"""
Created on Tue May  2 14:32:15 2023
...
ship_data_subset = ais_daily_mmsi.loc[(ais_daily_mmsi['YMD_HMS'].dt.month >= 6) & (ais_daily_mmsi['YMD_HMS'].dt.month <= 10)]
...
ship_gdf = GeoDataFrame(ship_data_subset, crs="epsg:3995", geometry=ship_data_subset['geometry'])
